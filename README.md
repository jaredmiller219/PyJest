...
- Progress: default inline ✓/✕/↷ glyphs render inside a framed “Progress” block with a centered legend; rows include small padding before the right border, and `--buffer` switches to a live status line with spinner, elapsed time, test index, and pass/fail/skip counts.
